...
<center>
    ...
    <a class="btn   mt-4 col-3 p-3 h1" href="/feedback/create" role="button" style="margin-left:85px;border-radius: 30px;background-color: #1a476d;color:gold;font-weight:bolder">Feedback</a><br><br>
    <a class="btn    col-3 p-3" href="/userrecipe/create" role="button" style="margin-left:85px;border-radius: 30px;background-color: #1a476d;color:gold;font-weight:bolder">Recommend Recipe</a><br><br>
